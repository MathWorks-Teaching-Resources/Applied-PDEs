classdef ProjectStartupApp < matlab.apps.AppBase
    ...
    properties (Access = private)
        ...
        GitHubRepository = "Applied-Partial-Differential-Equations";
    end
...
%}
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.WelcomeTitle.Text = 'Applied Partial Differential Equations';
            ...
            app.Image.ImageSource = 'CharacteristicCurveWithShock.png';
            ...
            app.ReviewTitle.Text = 'Welcome to Applied Partial Differential Equations';
